...
class Submission(models.Model):
    ...
    language = models.CharField(
        ...
        help_text=_(
            "Identifier for the programming language and version/compiler used."
        ),
    )
    ...
    execution_time_ms = models.IntegerField(
        _("execution time (ms)"), null=True, blank=True
    )
    ...
    )  # Float for percentage scores or partial points
