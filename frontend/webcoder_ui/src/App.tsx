      ...
      <main>
        <Routes>
          ...
          <Route
            ...
            element={
              <ProtectedRoute roles={['ADMIN', 'PROBLEM_CREATOR', 'PROBLEM_VERIFIER']}>
                <ProblemFormPage />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute
                roles={['ADMIN', 'PROBLEM_CREATOR', 'PROBLEM_VERIFIER', 'BASIC_USER']}
              >
                <MySubmissionsPage />
              </ProtectedRoute>
            }
          ...
          />
          <Route
            path="/admin/problem-queue"
            element={
              <ProtectedRoute roles={['ADMIN', 'PROBLEM_VERIFIER']}>
                <ProblemVerificationQueuePage />
              </ProtectedRoute>
            }
          />
          <Route
