		...
		if (auth.isAuthenticated) {
			const fetchSubmissions = async () => {
				...
				try {
					...
					setError(
						err.message ||
							t("error_loading_submissions", "Failed to load submissions."),
					);
				} finally {
					setLoading(false);
				}
			...
			if (!auth.isAuthenticated) {
				setError(
					t(
						"please_login_to_view_submissions",
		...
		<div>
			...
			>
				...
				<div>
					...
					>
						<option value="submission_time">
							{t("sort_option_time", "Time")}
						</option>
						<option value="score">{t("sort_option_score", "Score")}</option>
						<option value="language">
							{t("sort_option_language", "Language")}
						</option>
						<option value="verdict">
							{t("sort_option_verdict", "Verdict")}
						</option>
					</select>
				</div>
				<div>
